...
export type ColorPalette = "current" | "black" | "white" | "transparent" | "rose" | "pink" | "fuchsia" | "purple" | "violet" | "indigo" | "blue" | "sky" | "cyan" | "teal" | "emerald" | "green" | "lime" | "yellow" | "amber" | "orange" | "red" | "neutral" | "stone" | "zinc" | "gray" | "slate" | "base" | "content" | "primary" | "secondary" | "accent" | "info" | "success" | "warning" | "error" | "link" | "text" | "text.headings" | "text.code" | "dev"

export type AspectRatioToken = "square" | "landscape" | "portrait" | "wide" | "ultrawide" | "golden"

export type BorderToken = "none" | "default" | "field" | "selector"

export type EasingToken = "default" | "linear" | "in" | "out" | "in-out" | "drawer" | "navbar" | "btmDash" | "sidebar"

export type RadiusToken = "xs" | "sm" | "md" | "lg" | "xl" | "2xl" | "3xl" | "4xl" | "full" | "selector" | "field" | "box" | "sizes.selector" | "sizes.card.padding" | "sizes.card.sm" | "sizes.card.md" | "sizes.card.lg" | "sizes.field" | "depth" | "noise"
