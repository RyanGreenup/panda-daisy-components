import { For, Show, children, createEffect, createMemo, createSignal, mergeProps, onCleanup, onMount, splitProps } from "solid-js";
...
function styledFn(element, configOrCva = {}, options = {}) {
	...
	const StyledComponent = (props) => {
		...
		return createComponent(Dynamic, mergeProps(forwardedProps, elementProps, normalizeHTMLProps(htmlProps$1), {
			get component() {
